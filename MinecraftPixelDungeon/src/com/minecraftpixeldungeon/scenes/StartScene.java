...
import com.minecraftpixeldungeon.effects.BannerSprites.Type;
...
import com.minecraftpixeldungeon.windows.WndChallenges;
import com.minecraftpixeldungeon.windows.WndClass;
import com.minecraftpixeldungeon.windows.WndMessage;
import com.minecraftpixeldungeon.windows.WndOptions;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[MinecraftPixelDungeon.lastClass()] );
	...
	private void startNewGame() {
		...
		if (MinecraftPixelDungeon.intro()) {
			MinecraftPixelDungeon.intro( false );
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( MinecraftPixelDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add(new WndChallenges(MinecraftPixelDungeon.challenges(), true) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( MinecraftPixelDungeon.challenges() > 0 ?
