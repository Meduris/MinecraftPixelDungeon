...
import com.minecraftpixeldungeon.*;
...
import com.minecraftpixeldungeon.effects.BannerSprites;
import com.minecraftpixeldungeon.effects.BlobEmitter;
import com.minecraftpixeldungeon.effects.EmoIcon;
import com.minecraftpixeldungeon.effects.Flare;
import com.minecraftpixeldungeon.effects.FloatingText;
import com.minecraftpixeldungeon.effects.Ripple;
import com.minecraftpixeldungeon.effects.SpellSprite;
import com.minecraftpixeldungeon.items.Heap;
import com.minecraftpixeldungeon.items.Honeypot;
...
import com.minecraftpixeldungeon.levels.RegularLevel;
import com.minecraftpixeldungeon.levels.features.Chasm;
import com.minecraftpixeldungeon.levels.traps.Trap;
import com.minecraftpixeldungeon.plants.Plant;
import com.minecraftpixeldungeon.sprites.CharSprite;
import com.minecraftpixeldungeon.sprites.DiscardedItemSprite;
import com.minecraftpixeldungeon.sprites.HeroSprite;
import com.minecraftpixeldungeon.sprites.ItemSprite;
import com.minecraftpixeldungeon.sprites.PlantSprite;
import com.minecraftpixeldungeon.sprites.TrapSprite;
import com.minecraftpixeldungeon.ui.AttackIndicator;
import com.minecraftpixeldungeon.ui.Banner;
import com.minecraftpixeldungeon.ui.BusyIndicator;
import com.minecraftpixeldungeon.ui.CustomTileVisual;
import com.minecraftpixeldungeon.ui.GameLog;
import com.minecraftpixeldungeon.ui.HealthIndicator;
import com.minecraftpixeldungeon.ui.LootIndicator;
import com.minecraftpixeldungeon.ui.QuickSlotButton;
import com.minecraftpixeldungeon.ui.ResumeIndicator;
import com.minecraftpixeldungeon.ui.StatusPane;
import com.minecraftpixeldungeon.ui.Toast;
...
import com.minecraftpixeldungeon.windows.WndGame;
import com.minecraftpixeldungeon.windows.WndHero;
import com.minecraftpixeldungeon.windows.WndInfoCell;
import com.minecraftpixeldungeon.windows.WndInfoItem;
import com.minecraftpixeldungeon.windows.WndInfoMob;
import com.minecraftpixeldungeon.windows.WndInfoPlant;
import com.minecraftpixeldungeon.windows.WndInfoTrap;
import com.minecraftpixeldungeon.windows.WndMessage;
import com.minecraftpixeldungeon.windows.WndStory;
import com.minecraftpixeldungeon.windows.WndTradeItem;
import com.minecraftpixeldungeon.windows.WndBag.Mode;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		Music.INSTANCE.volume( MinecraftPixelDungeon.musicVol()/10f );

		MinecraftPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + MinecraftPixelDungeon.zoom(), maxZoom));
		...
		brightness( MinecraftPixelDungeon.brightness() );
	...
	public static void layoutTags() {
		...
		float tagLeft = MinecraftPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (MinecraftPixelDungeon.flipTags()) {
