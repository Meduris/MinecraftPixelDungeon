...
import com.minecraftpixeldungeon.actors.mobs.Tengu;
...
import com.minecraftpixeldungeon.levels.painters.MazePainter;
	...
	public void progress(){
		switch (state){
			...
			case FIGHT_ARENA:
				...
				vis.pos(7, 7);
				customTiles.add(vis);
				((GameScene)MinecraftPixelDungeon.scene()).addCustomTile(vis);
