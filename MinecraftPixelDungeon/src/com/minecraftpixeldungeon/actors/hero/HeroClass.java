...
import com.minecraftpixeldungeon.items.armor.ClothArmor;
import com.minecraftpixeldungeon.items.artifacts.CloakOfShadows;
import com.minecraftpixeldungeon.items.food.Food;
import com.minecraftpixeldungeon.items.potions.PotionOfMindVision;
...
import com.minecraftpixeldungeon.items.wands.WandOfMagicMissile;
import com.minecraftpixeldungeon.items.weapon.melee.Dagger;
import com.minecraftpixeldungeon.items.weapon.melee.MagesStaff;
import com.minecraftpixeldungeon.items.weapon.melee.ShortSword;
import com.minecraftpixeldungeon.items.weapon.missiles.Boomerang;
import com.minecraftpixeldungeon.items.weapon.missiles.Dart;
...
public enum HeroClass {
	...
	private static void initRogue( Hero hero ) {
		...
		if (MinecraftPixelDungeon.quickSlots() > 1)
