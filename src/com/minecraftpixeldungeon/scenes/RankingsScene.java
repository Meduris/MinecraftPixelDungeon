...
import com.minecraftpixeldungeon.windows.WndError;
import com.minecraftpixeldungeon.windows.WndRanking;
import com.watabou.utils.GameMath;

public class RankingsScene extends PixelScene {
	
	private static final String TXT_TITLE		= "Top Rankings - Minecraft PD";
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			if (Rankings.INSTANCE.totalNumber >= Rankings.TABLE_SIZE) {
				...
				won.hardlight( Window.MPX_COLOR );
				won.measure();
				add( won );
