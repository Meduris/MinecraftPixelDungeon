...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.minecraftpixeldungeon.actors.buffs.Poison.class ).
				set( com.minecraftpixeldungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
